...
COURSES = [
    ...
    {"university": "University of Melbourne", "title": "Doctor of Medicine", "level": "masters", "field": "Medicine", "duration": "4 years", "tuition_fee": 88000, "requirements": "Bachelor's degree (any discipline) with prerequisite science subjects, GAMSAT score, interview. IELTS 7.0+", "description": "Melbourne's graduate-entry medical degree combining clinical placements across major teaching hospitals with a strong research stream, preparing graduates for internship and specialist training pathways.", "application_url": "https://study.unimelb.edu.au/find/courses/graduate/doctor-of-medicine/", "deadline": date(2026, 9, 30)},
    ...
    {"university": "UNSW Sydney", "title": "Doctor of Medicine", "level": "masters", "field": "Medicine", "duration": "4 years", "tuition_fee": 85000, "requirements": "Bachelor's degree with prerequisite subjects, UCAT or GAMSAT score, interview. IELTS 7.0+", "description": "UNSW's MD emphasises clinical reasoning from year one, with placements across Sydney's major hospitals and a longitudinal research thread culminating in a research project.", "application_url": "https://www.unsw.edu.au/study/postgraduate/doctor-of-medicine", "deadline": date(2026, 7, 31)},
    ...
    {"university": "Monash University", "title": "PhD in Medicine", "level": "phd", "field": "Medicine", "duration": "3–4 years", "tuition_fee": 0, "requirements": "MBBS or equivalent medical degree, or Honours/Master's in a related health discipline. Research proposal. IELTS 7.0+", "description": "Research doctorate within Monash's Faculty of Medicine, Nursing and Health Sciences, covering translational medicine, public health, and clinical research across Monash's network of teaching hospitals.", "application_url": "https://www.monash.edu/medicine/research/degrees"},
    ...
    {"university": "University of Queensland", "title": "Doctor of Medicine", "level": "masters", "field": "Medicine", "duration": "4 years", "tuition_fee": 79500, "requirements": "Bachelor's degree (any discipline), GPA 5.0/7.0+, MCAT or GAMSAT score, interview. IELTS 7.0+", "description": "UQ's MD program is delivered across Brisbane, rural Queensland, and international clinical schools, with strong emphasis on evidence-based practice and community medicine.", "application_url": "https://study.uq.edu.au/study-options/programs/doctor-medicine-md", "deadline": date(2026, 10, 15)},
    ...
    {"university": "University of Adelaide", "title": "PhD in Medicine", "level": "phd", "field": "Medicine", "duration": "3–4 years", "tuition_fee": 0, "requirements": "MBBS, MD, or Honours degree in a health science. Research proposal and supervisor agreement. IELTS 7.0+", "description": "Doctoral research within Adelaide's Faculty of Health and Medical Sciences, spanning clinical trials, cancer research, cardiovascular medicine, and Indigenous health.", "application_url": "https://www.adelaide.edu.au/degree-finder/phd-medicine"},
